...
import type { AdminMessageNote } from '@/types/adminMessage'

interface MessageAdminNotesProps {
  notes: AdminMessageNote[]
  onAddNote: (body: string) => Promise<void>
}

export default function MessageAdminNotes({ notes, onAddNote }: MessageAdminNotesProps) {
    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Record follow-up, assignment context, or sender details."
        />
        <div className="mt-2 flex justify-end">
          <Button type="button" variant="primary" size="sm" disabled={!body.trim()} isLoading={saving} onClick={addNote}>
